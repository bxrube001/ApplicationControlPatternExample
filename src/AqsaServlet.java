...
final public class AqsaServlet extends HttpServlet{
    ...
    private void doProcess(HttpServletRequest request, HttpServletResponse response){
        ...
        final ControllersConfig ctrConfig = controllers.get(actionPath);
        ...
        } else throw new UnsupportedOperationException(format("action %s is not found in mapping file.", actionPath));
    }

    private void dispatchRequestToView(View view, WebConfig webConfig, HttpServletRequest request, HttpServletResponse response) {
        try {
